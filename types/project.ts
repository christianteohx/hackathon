...
export type UserProfile = { createdAt: string; displayName: string | null; email: string; id: string; organizationId?: string; updatedAt: string; };
export type Project = { createdAt: string; createdByUserId: string; demoUrl: string | null; description: string; eloRating?: number; githubUrl: string | null; id: string; joinCode: string; name: string; organizationId?: string; tagline: string; updatedAt: string; };
