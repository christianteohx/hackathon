...
export type Project = { createdAt: string; createdByUserId: string; demoUrl: string | null; description: string; eloRating?: number; githubUrl: string | null; id: string; joinCode: string; name: string; tagline: string; updatedAt: string; };
