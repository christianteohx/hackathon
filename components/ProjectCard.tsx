...
export function ProjectCard({
  ...
  // Prefer team_name, fall back to owner (which maps to team_name in app-state)
  const displayTeam = project.team_name || project.owner || null;
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          {avgScore != null && (
            <span className="inline-flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full bg-[var(--warning)]/10 text-[var(--warning)] border border-[var(--warning)]/20">
